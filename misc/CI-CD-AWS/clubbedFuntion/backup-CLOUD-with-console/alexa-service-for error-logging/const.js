...
module.exports = Object.freeze({
  ...
  cloudwatchLogger: {
    ...
    'region': 'us-east-1',
    'isEnabled': false // this flag will be used to enable the cloud watch logging.
  },
  errroLog:{
    'notFound':{message:"topic not found", code: 404},
    'exception':{message:"something went wrong", code: 400}
  }
